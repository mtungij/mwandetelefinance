...
<style> 
body {background-image: url('<?php echo base_url(); ?>assets/img/back1.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; } </style> <!-- WRAPPER --> 
